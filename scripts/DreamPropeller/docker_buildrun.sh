IMAGE_NAME=ogiex_dreampropeller
CONTAINER_NAME=ogiex_dreampropeller
...
if docker ps -a --format '{{.Names}}' | grep -Eq "^${CONTAINER_NAME}$"; then
    ...
    cd impl
    git clone https://github.com/alexzhou907/DreamPropeller --recursive ./
    git switch -d d7844af16edab4dfa94e124f2e3bdcf3a84268c9
