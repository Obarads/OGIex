IMAGE_NAME=ogiex_syncdreamer
CONTAINER_NAME=ogiex_syncdreamer
...
if docker ps -a --format '{{.Names}}' | grep -Eq "^${CONTAINER_NAME}$"; then
    ...
    cd impl
    git clone https://github.com/liuyuan-pal/SyncDreamer --recursive ./
    git switch -d 232a2ec22f0277b4bd429109fb34eaf8f61b13ad
