IMAGE_NAME=ogiex_richdreamer
CONTAINER_NAME=ogiex_richdreamer
...
if docker ps -a --format '{{.Names}}' | grep -Eq "^${CONTAINER_NAME}$"; then
    ...
    cd impl
    git clone https://github.com/modelscope/richdreamer --recursive ./
    git switch -d d1f5895dc8ecc75760619e505f1d81f61886091b
